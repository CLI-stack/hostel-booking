...
/**
 * Stateless EJB that runs seed logic inside its own container-managed transaction.
 * Called by DataInitializer @PostConstruct — ensures DDL is applied before seeding.
 */
@Stateless
public class SeedService {
    ...
    public void seed() {
        ...
        LOG.info("=== Hostel Booking System seed data loaded ===");
    }
    ...
    private void seedStudentUsers() {
        if (userDAO.findByUsername("student1").isEmpty()) {
            ...
            LOG.info("Student users created");
        }
    }
